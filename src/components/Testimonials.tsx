    ...
    return (
        <section id="testimonials" className="py-24 md:py-32 bg-black text-cream overflow-hidden relative">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div
                    className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pb-8"
                >
                    {reviews.map((review, index) => (
                        <motion.div
                            ...
                            className="bg-zinc-900 border border-zinc-800 p-6 md:p-8 rounded-2xl relative flex flex-col justify-between"
                        >
                            ...
                            <p className="text-base text-cream/90 font-body mb-6 md:mb-8 italic leading-relaxed">"{review.text}"</p>
